defmodule Shared.Infrastructure.Saga.CommandDispatcher do
  ...
  @command_service_channel Application.compile_env(:shared, :command_service_grpc_url, "localhost:50051")
  ...
  def dispatch_command(command) do
    ...
    try do
      case command.command_type do
        type when type in ["reserve_inventory", "process_payment", "arrange_shipping", 
                          "confirm_order", "release_inventory", "refund_payment", 
                          "cancel_shipping", "cancel_order"] ->
