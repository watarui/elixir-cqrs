defmodule CommandService.Infrastructure.EventSourcingIntegrationTest do
  ...
  describe "Command to Event Flow" do
    ...
    test "category hierarchy creation generates multiple events" do
      ...
      parent_command = CreateCategoryCommand.new(%{
      ...
      child_command = CreateCategoryCommand.new(%{
        name: "Child Category",
        description: "Child",
        parent_id: parent_id,
        metadata: test_metadata()
  ...
  describe "Snapshot Management" do
    test "creates and retrieves snapshots" do
      ...
      snapshot = create_snapshot(aggregate_id, %{
        name: "Snapshot State",
      ...
      events_after_snapshot = PostgresEventStore.get_events(
        aggregate_id, 
        after_version: 15
      )
