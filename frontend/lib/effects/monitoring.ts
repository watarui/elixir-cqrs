...
export class MonitoringService extends Context.Tag("MonitoringService")<
  MonitoringService,
  {
    readonly fetchSagas: Effect.Effect<Array<Saga>>
    readonly fetchEvents: Effect.Effect<Array<Event>>
    readonly subscribeToEvents: Stream.Stream<Event>
    readonly getMetrics: Effect.Effect<SystemMetrics>
  }
>() {}
...
export class DatabaseService extends Context.Tag("DatabaseService")<
  DatabaseService,
  {
    readonly queryEventStore: (sql: string) => Effect.Effect<Array<any>>
    readonly queryCommandDb: (sql: string) => Effect.Effect<Array<any>>
    readonly queryQueryDb: (sql: string) => Effect.Effect<Array<any>>
  }
>() {}
